                ...
                LazyVGrid(columns: [.init(), .init()]) {
                    ...
                    NavigationLink {
                       PottyTimesView(pet: pet)
                        ...
                        HealthJournalRowView(icon: "lightPurpleColor", text: "Potty Times", image: "Potty")
                    }
                    ...
                    NavigationLink {
                       WalkingTimesView(pet: pet)
                        ...
                        HealthJournalRowView(icon: "HealthJournalColor", text: "Walking Times", image: "Socialize")
                    }
